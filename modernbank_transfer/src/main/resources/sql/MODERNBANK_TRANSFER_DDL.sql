-- Create TB_TRNF_HST table (including PRIMARY KEY)
CREATE TABLE IF NOT EXISTS TB_TRNF_HST
(
...
-- Create TB_TRNF_LMT table (including PRIMARY KEY)
CREATE TABLE IF NOT EXISTS TB_TRNF_LMT
(
