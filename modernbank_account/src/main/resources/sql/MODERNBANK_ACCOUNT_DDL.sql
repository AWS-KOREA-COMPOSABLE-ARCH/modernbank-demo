-- TB_ACNT 테이블 생성 (PRIMARY KEY 포함)
CREATE TABLE IF NOT EXISTS TB_ACNT
(
  ACNT_NO   VARCHAR(20) NOT NULL PRIMARY KEY,  -- PRIMARY KEY 여기에 직접 지정
...
-- TB_TRNS_HST 테이블 생성 (PRIMARY KEY 포함)
...
(
  ...
  PRIMARY KEY (ACNT_NO, SEQ)  -- 복합 PRIMARY KEY 여기에 지정
);
