-- Create TB_ACNT table (including PRIMARY KEY)
CREATE TABLE IF NOT EXISTS TB_ACNT
(
  ACNT_NO   VARCHAR(20) NOT NULL PRIMARY KEY,  -- PRIMARY KEY specified directly here
...
-- Create TB_TRNS_HST table (including PRIMARY KEY)
CREATE TABLE IF NOT EXISTS TB_TRNS_HST
(
  ...
  PRIMARY KEY (ACNT_NO, SEQ)  -- Composite PRIMARY KEY specified here
);
...
-- Create SEQUENCE
CREATE SEQUENCE IF NOT EXISTS SEQ_ACCOUNT_TRANSACTION_HISTORY;
